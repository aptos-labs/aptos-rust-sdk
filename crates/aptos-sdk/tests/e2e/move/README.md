...
|---------|--------|---------------|-----------|
| `one_signer_transfer/` | Single-signer transfer | `one_signer_transfer.mv` | `e2e_script_transfer` (runtime read; panics if .mv missing—see compile instructions below) |
| `two_signer_transfer/` | Two-signer transfer | `two_signer_transfer.mv` | `e2e_multi_agent_transaction`, `e2e_simulate_multi_agent_then_submit` (runtime read; panics if .mv missing) |
