...
aptos-sdk = { version = "0.7.1", default-features = false, features = ["ed25519"] }

# Full features
aptos-sdk = { version = "0.7.1", features = ["full"] }
```
...
```toml
[dependencies]
aptos-sdk = { version = "0.7.1", default-features = false, features = ["ed25519", "faucet"] }
```
...
```toml
[dependencies]
aptos-sdk = { version = "0.7.1", features = ["ed25519", "secp256k1", "faucet"] }
```
